...
sed -i 's|ip=dhcp|ip=${fraStaticIp}::${gwPrimary}:255.255.254.0::ens6:none|g' "$BLS"
...
`);
      ...
      const providerSpec = {
        ...
        nics: [
          frankfurtDiversity
            ? { lan: lanId, dhcp: false, ips: [],  firewallActive: false, name: `${targetMsName}-nic0` }
      ...
      const fraAnnotations = frankfurtDiversity ? {
